...
class TestCard(TypedDict):
    """Type definition for a test card."""
...
TEST_CARDS = {
    ...
    "SECURE_3DS_FRICTIONLESS_WITH_3DS": TestCard(
    ...
    "SECURE_3DS_FRICTIONLESS_NO_3DS": TestCard(
    ...
    "SECURE_3DS_CHALLENGE_WITH_3DS": TestCard(
    ...
    "SECURE_3DS_CHALLENGE_NO_3DS": TestCard(
...
def get_card(key: TestCardKey) -> TestCard:
    """
...
def get_random_card(exclude_cards: Optional[List[TestCardKey]] = None) -> TestCard:
    """
